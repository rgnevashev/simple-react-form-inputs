...
var DatetimeField = function (_React$Component) {
  ...
  (0, _createClass3.default)(DatetimeField, [{
    ...
    value: function onChange(date) {
      var value = _.isString(date) ? (0, _moment2.default)(date).toDate() : date.toDate();
...
DatetimeField.propTypes = (0, _extends3.default)({}, _propTypes.propTypes, {
  timeConstraints: _react2.default.PropTypes.object,
  timezone: _react2.default.PropTypes.any
});
DatetimeField.defaultProps = (0, _extends3.default)({}, _propTypes.defaultProps, {
  timezone: false,
  timeConstraints: {
    minutes: {
      step: 5
