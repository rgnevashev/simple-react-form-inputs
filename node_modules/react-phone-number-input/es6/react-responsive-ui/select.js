...
var Select = function (_PureComponent) {
	...
	_createClass(Select, [{
		...
		value: function render_selected_item_only() {
			...
			var concise = _props5.concise;
			var tabIndex = _props5.tabIndex;
			var onFocus = _props5.onFocus;
			var inputClassName = _props5.inputClassName;
		...
		value: function render_static() {
			...
			var toggler = _props6.toggler;
			var fallback = _props6.fallback;
		...
		value: function should_indicate_invalid() {
			...
			var indicateInvalid = _props7.indicateInvalid;
		...
		value: function overflown() {
			...
			var maxItems = _props10.maxItems;
...
var _initialiseProps = function _initialiseProps() {
	...
	this.toggle = function (event) {
		...
		var focusUponSelection = _props13.focusUponSelection;
		var onToggle = _props13.onToggle;
		var nativeExpanded = _props13.nativeExpanded;
