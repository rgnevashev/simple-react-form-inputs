...
var Input = function (_Component) {
	...
	_createClass(Input, [{
		...
		value: function render() {
			...
			var input_props = _objectWithoutProperties(_props3, ['saveOnIcons', 'showCountrySelect', 'nativeExpanded', 'disabled', 'autoComplete', 'selectTabIndex', 'selectMaxItems', 'inputTabIndex', 'style', 'className', 'inputClassName', 'dictionary', 'countries', 'country', 'onCountryChange', 'flags', 'flagsPath', 'international', 'internationalIcon', 'convertToNational', 'metadata']);
...
var _initialiseProps = function _initialiseProps() {
	...
	this.format = function (value) {
		var country_code = arguments.length <= 1 || arguments[1] === undefined ? _this3.state.country_code : arguments[1];
		var metadata = _this3.props.metadata;
